...
export default function EventPanel({ event, onClose, onShare }: EventPanelProps) {
  ...
  useEffect(() => {
    ...
    params.set("artists", parsedArtists.join(","));
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {artist.instagramUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-shrink-0 text-pink-500/70 hover:text-pink-400 transition-colors"
                            title="Instagram"
                          >
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        {artist.bandcampUrl && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex-shrink-0 text-cyan-500/70 hover:text-cyan-400 transition-colors"
                            title="Bandcamp"
                          >
                            <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor">
